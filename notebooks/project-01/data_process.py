...
def preprocess_data(df: pd.DataFrame, target_column: str = "heart disease") -> Tuple[pd.DataFrame, pd.Series, list, list]:
...
def prepare_data(X: pd.DataFrame, y: pd.Series) -> Tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series]:
